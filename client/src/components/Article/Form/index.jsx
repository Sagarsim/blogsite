...
class Form extends React.Component {
 ...
 handleSubmit = (event) => {
  const { onSubmit, onEdit, articleToEdit } = this.props;
    ...
    if(!articleToEdit){
    return axios.post('https://glacial-bastion-35164.herokuapp.com/api/articles', {
      title,
      body,
      author,
    })
      ...
      .then(() => this.setState({title: '', body: '', author: ''}))
        ...
        return axios.patch(`https://glacial-bastion-35164.herokuapp.com/api/articles/${articleToEdit._id}`, {
          title,
          body,
          author,
        })
